...
<head>
    ...
    <title>Files Shared by Me</title>
...
<body>
    ...
    // Get the files that the user has shared with others
    FileDAO fileDAO = new FileDAO();
    List<File> sharedFilesByMe = fileDAO.getFilesSharedByUser(username); // Method to get files shared by the user
    %>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="index.jsp" class="flex items-center ps-2.5 mb-5">
                <img src="GoogleDrive.png" class="h-6 me-3 sm:h-7" alt="Logo" />
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li><a href="myDrive.jsp"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-file-shield"></i> <span class="flex-1 ms-3 whitespace-nowrap">My Drive</span>
                </a></li>
                <li><a href="starred.jsp"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-regular fa-star"></i> <span class="flex-1 ms-3 whitespace-nowrap">Starred</span>
                </a></li>
                
                <li><a href="sharedFiles.jsp"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-user-group"></i> <span class="flex-1 ms-3 whitespace-nowrap">Shared with Me</span>
                </a></li>
                ...
                <li><a href="logout"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-right-from-bracket"></i> <span class="flex-1 ms-3 whitespace-nowrap">Logout</span>
                </a></li>
            </ul>
        </div>
    </aside>
    ...
    <div class="p-4 sm:ml-64">
        <h1 class="text-2xl my-4">Files I Have Shared</h1>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <%
                        if (sharedFilesByMe != null && !sharedFilesByMe.isEmpty()) {
                            for (File file : sharedFilesByMe) {
                        %>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <button 
                                    onclick="window.location.href='FileSharedUsersServlet?fileId=<%= file.getId() %>'"
