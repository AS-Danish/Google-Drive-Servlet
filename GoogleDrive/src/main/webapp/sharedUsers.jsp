...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <h1 class="text-2xl my-4">Users with whom the file is shared</h1>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table
                    ...
                    <tbody>
                        <%
                        List<String> sharedUsers = (List<String>) request.getAttribute("sharedUsers");
                        String fileId = (String) request.getAttribute("fileId"); // Assuming fileId is passed from the servlet
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <!-- Invoke Access Button -->
                                <form action="RevokeAccessServlet" method="post" style="display:inline;">
                        ...
                        %>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4 text-gray-500" colspan="2">
        ...
        <!-- Back to Shared Files Button at the bottom -->
    <a href="invokeFiles.jsp" class="bg-blue-600 text-white font-medium rounded-md px-4 py-2 my-10 mx-5 hover:bg-blue-700 transition duration-200 ease-in-out">
